...
def get_plot_data(prefix, exp_id, stat_type='objective'):
    evals, _, q25, mean, q75, _ = get_experiment_stats(
        prefix, exp_id, stat_type)
...
def summarize_experiment(prefix, exp_id):
    evals, lower, q25, mean, q75, upper = get_experiment_stats(
        prefix, exp_id, 'fitness')
